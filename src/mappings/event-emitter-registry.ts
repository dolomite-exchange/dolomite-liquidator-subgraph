...
} from './event-emitter-registry-helpers'
import { getOrCreateMarginAccount } from './dolomite-margin'
...
export function handleAsyncDepositCreated(event: AsyncDepositCreatedEvent): void {
  ...
  deposit.effectiveUser = marginAccount.user
...
export function handleAsyncWithdrawalCreated(event: AsyncWithdrawalCreatedEvent): void {
  ...
  withdrawal.effectiveUser = marginAccount.user
